...
namespace p2t
{
	...
	class BDMFile
	{
		...
		BDMFile(const ClipperLib::Path& _Polygon, const ClipperLib::Paths& _Holes);
		~BDMFile();
		...
		void ComputePolys(const ClipperLib::Path& _Polygon, const ClipperLib::Paths& _Holes);
	...
	class Polygon : public BDMFile
	{
		...
		Polygon(const ClipperLib::Path& _Polygon, const ClipperLib::Paths& _Holes);
		~Polygon();
